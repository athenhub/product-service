...
public class ProductPermissionPolicy implements PermissionPolicy {
   ...
   */
  @Override
  public boolean isCreateDenied(UUID userId, HubId hubId, VendorId vendorId) {
   ...
   */
  @Override
  public boolean isUpdateDenied(UUID userId, HubId hubId, VendorId vendorId) {
    // TODO: 사용자-허브-업체 관계 및 역할(Role) 기반 권한 검증 로직 구현
    return false;
  }
   ...
   */
  @Override
  public boolean isDeleteDenied(UUID userId, HubId hubId) {
